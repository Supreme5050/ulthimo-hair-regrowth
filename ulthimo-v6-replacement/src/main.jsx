        ...
        <section className="hero">
          ...
          <div className="container hero-inner">
            <div className="hero-copy reveal">
              <span className="eyebrow"><CircleCheck size={16}/> Men's Extra Strength Hair Regrowth Kit</span>
              <h1>
        ...
        <section id="details" className="detail-section">
          <div className="container detail-grid">
            <div className="detail-copy reveal">
              ...
              <h2>See the kit clearly before you order.</h2>
              <p>Take a closer look at the pack, the size shown on the box and the presentation of the full kit before you continue to WhatsApp.</p>
            ...
            <div className="detail-media reveal">
              <div className="detail-stack">
                <div className="detail-shot main-shot">
                  <img src="/details-main.jpg" alt="Ulthimo product display"/>
                </div>
                <div className="detail-shot accent-shot">
